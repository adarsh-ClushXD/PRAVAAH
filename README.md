...
*   **Explainable AI (XAI) Reasoning**: Real-time flood risk assessment powered by **Gemma 4** via Google AI Studio API.
...
*   **AI Engine**: Google AI REST API (Gemma 4 / Gemma 2).
...
graph TD
    ...
    B -->|AI Analysis| E[Google Gemma API]
```
...
*   **Backend**: Can be hosted easily on **[Render](https://render.com/)** or **[Railway](https://railway.app/)** with `GEMMA_API_KEY` injected as an environment variable.
